  ...
  return (
    <div style={{ display:'flex', minHeight:'100vh' }}>
      ...
      <aside style={{
        ...
        <div style={{ padding:'20px 20px 16px', display:'flex',
                      alignItems:'center', gap:'10px' }}>
          <div style={{ width:36, height:36, background:'#2563eb',
        ...
        <div style={{ margin:'0 12px 16px', padding:'8px 12px',
        ...
        <nav style={{ flex:1, padding:'0 8px', display:'flex',
      ...
      {/* Main */}
      <div style={{ marginLeft: open ? '230px' : '0px',
